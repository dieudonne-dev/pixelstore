...
Boutique en ligne de matériel informatique — catalogue produits, panier et tunnel de commande, entièrement développée en HTML, CSS et JavaScript.
...
```bash
   git clone https://github.com/dieudonne-dev/pixelstore.git
```
...
**Dieudonne Safari** ([@dieudonne-dev](https://github.com/dieudonne-dev))
